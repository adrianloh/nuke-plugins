# assemble-ndk-windows_x86_64.ps1
# Collects the Windows x86_64 Nuke 15.2v9 NDK bits needed to build plugins in CI
# into ./nuke-ndk-15.2v9/windows_x86_64/ in the current directory.

$ErrorActionPreference = "Stop"

$NukeRoot = "C:\Program Files\Nuke15.2v9"
$DestRoot = Join-Path (Get-Location) "nuke-ndk-15.2v9\windows_x86_64"
